...
document.addEventListener('DOMContentLoaded', async function() {
    // Envia a solicitação AJAX assim que a página for carregada
    $.ajax({
        type: 'GET',
        url: '/aboutUser/admin',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
                // Mostrar ou esconder o link dependendo do tipo de usuário
